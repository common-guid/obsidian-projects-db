	...
	describe('parseFileCache', () => {
		it('should return a ParentTask and Subtasks from valid CachedMetadata', () => {
			const mockMetadata: CachedMetadata = {
				...
				headings: [
					{ heading: 'Subtask 1', level: 1, position: { start: { line: 5, offset: 50, col: 0 }, end: { line: 5, offset: 60, col: 10 } } },
					{ heading: 'Subtask 2', level: 2, position: { start: { line: 10, offset: 100, col: 0 }, end: { line: 10, offset: 110, col: 10 } } }
				]
			};
		...
		it('should handle paths without slashes', () => {
			const result = parseFileCache('Simple.md', { frontmatter: { type: 'task' } });

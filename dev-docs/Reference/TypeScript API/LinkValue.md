...
[Value](Value) wrapping an internal wikilink.
...
|  [`parseFromString(app, input, sourcePath)`](LinkValue/parseFromString) | <code>static</code> | Create a new LinkValue from wikilink syntax. |
